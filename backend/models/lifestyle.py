...
class LifestyleProfile(BaseModel):
    ...
    user_id: PyObjectId
    bmi: float
    age: Optional[float] = None                # years — used by all v2 disease subsets
    systolic_bp: Optional[float] = None        # mmHg — used by Diabetes, CVD, CKD
    diastolic_bp: Optional[float] = None       # mmHg — used by Diabetes, CVD, CKD
